...
//	@CrossOrigin(origins = "*")
   ...
   public String verifyAccount(@Param("code") String code,Model model) {
	   ...
	   return "------------------------register/" + (verified ? "verify_success please check your database the enabled value change 0 to 1" : "verify_fall------------");
...
//       }
   ...
   @GetMapping("/getByName/{name}")
	...
	public List<Admin> getbyname(@PathVariable String name) {
		...
		return adminserviceimpl.getAdminByname(name);
	}
