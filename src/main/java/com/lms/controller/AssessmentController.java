...
AssessmentServiceImpl assessmentserviceimpl;
	...
	public Assessment insert(@RequestBody Assessment assessment )
	{
		logger.trace("Register in assessment working properly");
		
		return assessmentserviceimpl.insertdata(assessment);
	...
	public ResponseEntity<Map<String,String>> delete(@PathVariable Long AId)
	{
		logger.trace("Delete data in assessment working properly");
		//Map<String,String> response=new HashMap<>();
		return assessmentserviceimpl.deletedata(AId);
