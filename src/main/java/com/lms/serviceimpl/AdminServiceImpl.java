...
//			    String fromAddress = "Your email address";
			    String senderName = "Your True lover";
			    String subject = "Please verify your love";
			    String mailContent = "Dear Rani,<br>";
			           mailContent += "<p>Please click the link below to verify your true love rani mare jaan(Ye Zindagi chahe Kitne Pal Ki Bhi Mile, Bas Yahi Dua Hai Bas Tere Sang Mile.):</p>";
...
//			           mailContent += "<h3><a =\"href=" +verifyURL +"\" >VERIFY</a></h3>";
			           mailContent += "<h3><a href=\"" +verifyURL +"\" >VERIFY</a></h3>";
			           mailContent +="<p> Thank you<br> true love</p>";
...
//	        adminrepo.save(admin);
	...
	public List<Admin> getAdminByname(String admin_name) {
		// TODO Auto-generated method stub
		return adminrepo.getAdminByname(admin_name);
	}
